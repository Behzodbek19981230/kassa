...
export default function TelegramBroadcastPage() {
  ...
  const columns = [
    ...
    columnHelper.accessor('warehouses_count', { header: 'Warehouse soni', size: 130 }),
    columnHelper.accessor('clients_count', { header: 'Client soni', size: 110 }),
  ...
  return (
    <>
      ...
      <Panel
        title="Ro'yxat"
        actions={
          <Button type='button' variant='info' size='xs' onClick={() => navigate('/telegram-broadcast/create')}>
