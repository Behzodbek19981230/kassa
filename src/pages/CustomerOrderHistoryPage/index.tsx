...
import { useOrderAccountHistoryListQuery } from '@/services/order-account-history/order-account-history.queries';
...
const columnHelper = createColumnHelper<OrderAccountHistoryItem>();
...
export default function CustomerOrderHistoryPage() {
	...
	const { data, isLoading, isFetching, isError, refetch } = useOrderAccountHistoryListQuery({
