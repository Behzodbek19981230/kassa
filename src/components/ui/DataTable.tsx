            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <TableHead
                    key={header.id}
                    className={cn('relative', enableBordered && 'border-x border-t border-ca-border')}
                    ...
                    {enableColumnResizing && header.column.getCanResize() && (
                      <div
                        ...
                        className={cn(
                          ...
                          header.column.getIsResizing() ? 'bg-ca-theme' : 'hover:bg-ca-border',
                        )}
                      />
                    )}
                  </TableHead>
              ...
              table.getRowModel().rows.map((row, index) => (
                <Fragment key={row.id}>
                  ...
                  {enableExpanding && row.getIsExpanded() && (
                    <TableRow>
                      <TableCell colSpan={row.getVisibleCells().length} className="bg-ca-silver-light">
